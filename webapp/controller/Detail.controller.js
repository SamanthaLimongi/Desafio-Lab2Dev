sap.ui.define([
	...
	return BaseController.extend("desafio.controller.Detail", {
		...
		_onObjectMatched: function (oEvent) {
			...
			this._oObjectId = oArguments.objectId;
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("Orders", {
					OrderID: this._oObjectId
				});
				this._bindView("/" + sObjectPath);
			}.bind(this));

			//Define tab shipping initial
			var oQuery = oArguments["?query"];
			if (oQuery && this._aKeys.indexOf(oQuery.tab) >= 0) {
