sap.ui.define([
	...
	"../model/formatter"
], function (BaseController, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, Fragment, DateFormat, formatter) {
	"use strict";

	return BaseController.extend("desafio.controller.Master", {
		...
		onInit: function () {
			...
			this._oGroupFunctions = {
				...
				OrderDate: function (oContext) {
					var oDate = oContext.getProperty("OrderDate"),
						...
						sMonthName = this._oMonthFormat.format(oDate);
			...
			//used in group by date
			this._oMonthFormat = DateFormat.getInstance({ pattern: "MMMM" });
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "desafio.view.ViewSettingsDialog",
					controller: this
