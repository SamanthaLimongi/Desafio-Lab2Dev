		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Desafio-Lab2Dev",
									"targetURL": "#DesafioLab2Dev-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DesafioLab2Dev-display": {
								"semanticObject": "DesafioLab2Dev",
								"action": "display",
								"description": "Desafio-Lab2Dev",
								"title": "Desafio-Lab2Dev",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=desafio",
									"url": sap.ui.require.toUrl("desafio")
								}
							}
						}
					}
